...
const copy = {
  zh: {
    ...
    navButtons: { toggle: 'EN', register: '注册', login: '登录', imageCreation: '图像创作', help: '帮助文档', enterprise: '企业服务', trial: '免费体验' },
  ...
  en: {
    ...
    navButtons: { toggle: '中文', register: 'Register', login: 'Log in', imageCreation: 'Image Studio', help: 'Help', enterprise: 'Enterprise', trial: 'Free Trial' },
